    ...
    return function(e) {
        ...
        __w_pdfjs_require__.t = function(e, t) {
            ...
            if (2 & t && "string" != typeof e)
                for (var n in e) __w_pdfjs_require__.d(r, n, function(t) {
                    return e[t]
                }.bind(null, n));
            return r
        };
        ...
        var n = r(1),
            ...
            let t;
            (0, n.isFetchSupported)() && (t = r(25).PDFFetchStream);
        ...
        var _util = __w_pdfjs_require__(2),
            ...
            _font_loader = __w_pdfjs_require__(5),
            _node_utils = __w_pdfjs_require__(6),
        ...
        function getDocument(e) {
            ...
            a.promise.then((function() {
                ...
                return Promise.all([e, r]).then((function([e, r]) {
                    ...
                    t._transport = o;
                    s.send("showUnverifiedSignatures", window.ServiceWorkerOptions.showUnverifiedSignatures);
                    s.send("Ready", null)
                }))
        ...
        const PDFWorker = function PDFWorkerClosure() {
            ...
            function getWorkerSrc() {
                if (_worker_options.GlobalWorkerOptions.workerSrc) return "Function" === _worker_options.GlobalWorkerOptions.workerSrc.constructor.name ? _worker_options.GlobalWorkerOptions.workerSrc() : _worker_options.GlobalWorkerOptions.workerSrc;
        ...
        class WorkerTransport {
            constructor(e, t, r, n) {
                ...
                this._params = n;
                let s = n.cMapUrl;
                "Function" === s.constructor.name && (s = s());
            ...
            o = function CanvasGraphicsClosure() {
                ...
                function putBinaryImageData(e, t, r = null) {
                    ...
                    if (t.kind === n.ImageKind.GRAYSCALE_1BPP) {
                        var C = m.byteLength,
                            S = new Uint32Array(A.buffer, 0, A.byteLength >> 2),
                            x = S.length,
                            k = h + 7 >> 3,
                            P = 4294967295,
                            w = n.IsLittleEndianCached.value ? 4278190080 : 255;
                        y && 255 === y[0] && 0 === y[255] && ([P, w] = [w, P]);
                        for (a = 0; a < p; a++) {
                            o = a < u ? 16 : d;
                            s = 0;
                            for (i = 0; i < o; i++) {
                                var T = C - g;
                                let e = 0;
                                for (var R = T > k ? h : 8 * T - 7, E = -8 & R, F = 0, L = 0; e < E; e += 8) {
                                    L = m[g++];
                                    S[s++] = 128 & L ? P : w;
                                    S[s++] = 64 & L ? P : w;
                                    S[s++] = 32 & L ? P : w;
                ...
                CanvasGraphics.prototype = {
                    ...
                    constructPath: function CanvasGraphics_constructPath(e, t) {
                        for (var r = this.ctx, s = this.current, a = s.x, i = s.y, o = 0, l = 0, c = e.length; o < c; o++) switch (0 | e[o]) {
                    ...
                    showText: function CanvasGraphics_showText(e) {
                        ...
                        var _ = t.lineWidth,
                            b = t.textMatrixScale;
                        if (0 === b || 0 === _) {
                            var v = t.textRenderingMode & n.TextRenderingMode.FILL_STROKE_MASK;
                            if (v === n.TextRenderingMode.STROKE || v === n.TextRenderingMode.FILL_STROKE) {
                                this._cachedGetSinglePixelWidth = null;
                                _ = .65 * this.getSinglePixelWidth()
                            }
                        } else _ /= b;
                        if (1 !== i) {
                            a.scale(i, i);
                        ...
                        for (y = 0; y < d; ++y) {
                            ...
                            if ((0, n.isNum)(S)) C += p * S * s / 1e3;
                                ...
                                if (this.contentVisible && (S.isInFont || r.missingFile))
                                    if (m && !F) a.fillText(E, x, k);
                                    else {
                                        this.paintChar(E, x, k, A);
                                        if (F) {
                                            P = x + s * F.offset.x / i;
                                            w = k - s * F.offset.y / i;
                                            this.paintChar(F.fontChar, P, w, A)
                                        }
                                    } C += u ? L * g - R * c : L * g + R * c;
                                T && a.restore()
                            }
                            ...
                            for (t = 0; t < m; ++t) {
                                ...
                                if ((0, n.isNum)(r)) {
                                    ...
                                    if (_) {
                                        ...
                                        s = n.Util.applyTransform([r.width, 0], g)[0] * c + A;
                                        i.translate(s, 0);
                                        o.x += s * f
                        ...
                        if (this.contentVisible) {
                            ...
                            i && void 0 === i.compiled && (i.compiled = r <= 1e3 && n <= 1e3 ? function compileType3Glyph(e) {
                                ...
                                for (t = 1; t < i; t++) {
                                    ...
                                    for (r = 1; r < a; r++) {
                                        if (c[A = (A >> 2) + (u[p + 1] ? 4 : 0) + (u[p - h + 1] ? 8 : 0)]) {
                                            l[n + r] = c[A];
                                            ++m
                                        }
                                        p++
                    ...
                    paintImageXObjectRepeat: function CanvasGraphics_paintImageXObjectRepeat(e, t, r, s) {
                        ...
                        if (a) {
                            for (var i = a.width, o = a.height, l = [], c = 0, h = s.length; c < h; c += 2) l.push({
                    ...
                    paintInlineImageXObject: function CanvasGraphics_paintInlineImageXObject(e) {
                        if (this.contentVisible) {
                            ...
                            this.save();
                            n.scale(1 / t, -1 / r);
                            var s, a, i = n.mozCurrentTransformInverse,
                                o = i[0],
                                l = i[1],
                            ...
                            for (var f = t, g = r, m = "prescale1"; c > 2 && f > 1 || u > 2 && g > 1;) {
                                var A = f,
                                    _ = g;
                                c > 2 && f > 1 && (c /= f / (A = Math.ceil(f / 2)));
                                u > 2 && g > 1 && (u /= g / (_ = Math.ceil(g / 2)));
                                (p = (a = this.cachedCanvases.getCanvas(m, A, _)).context).clearRect(0, 0, A, _);
                                p.drawImage(s, 0, 0, f, g, 0, 0, A, _);
                                s = a.canvas;
                                f = A;
                                g = _;
        ...
        var a = function createMeshCanvasClosure() {
            function drawTriangle(e, t, r, n, s, a, i, o) {
                ...
                var p = (c[r] + t.offsetX) * t.scaleX,
                    ...
                    A = (c[s] + t.offsetX) * t.scaleX,
                    _ = (c[s + 1] + t.offsetY) * t.scaleY;
                if (!(f >= _))
                    for (var b, v, y, C, S, x, k, P, w = h[a], T = h[a + 1], R = h[a + 2], E = h[i], F = h[i + 1], L = h[i + 2], M = h[o], O = h[o + 1], D = h[o + 2], I = Math.round(f), N = Math.round(_), j = I; j <= N; j++) {
                        if (j < m) {
                            let e;
                        ...
                        let e;
                        e = j < f ? 0 : j > _ ? 1 : (f - j) / (f - _);
                        S = p - (p - A) * e;
                        x = w - (w - M) * e;
                        k = T - (T - O) * e;
                        P = R - (R - D) * e;
                        for (var G = Math.round(Math.min(b, S)), U = Math.round(Math.max(b, S)), W = u * j + 4 * G, B = G; B <= U; B++) {
                            e = (b - B) / (b - S);
                            e < 0 ? e = 0 : e > 1 && (e = 1);
                            d[W++] = v - (v - x) * e | 0;
                            d[W++] = y - (y - k) * e | 0;
            ...
            return function createMeshCanvas(e, t, r, n, s, a, i, o) {
                var l, c, h, d, u = Math.floor(e[0]),
                    p = Math.floor(e[1]),
                    f = Math.ceil(e[2]) - u,
                    g = Math.ceil(e[3]) - p,
                    m = Math.min(Math.ceil(Math.abs(f * t[0] * 1.1)), 3e3),
                    A = Math.min(Math.ceil(Math.abs(g * t[1] * 1.1)), 3e3),
                    _ = f / m,
                    b = g / A,
                    v = {
                        coords: r,
                ...
                if (o.isEnabled) {
                    ...
                    (c = i.getCanvas("mesh", y, C, !1)).context.drawImage(l, 2, 2);
                    l = c.canvas
                } else {
                    var S = (c = i.getCanvas("mesh", y, C, !1)).context,
                        x = S.createImageData(m, A);
                    if (a) {
                        var k = x.data;
                    ...
                    for (h = 0; h < s.length; h++) drawFigure(x, s[h], v);
            ...
            TilingPattern.prototype = {
                createPatternCanvas: function TilinPattern_createPatternCanvas(e) {
                    ...
                    var h = r[0],
                        ...
                        m = [f[0] * g[0], f[1] * g[1]],
                        A = this.getSizeAndScale(s, this.ctx.canvas.width, m[0]),
                        _ = this.getSizeAndScale(a, this.ctx.canvas.height, m[1]),
                        b = e.cachedCanvases.getCanvas("pattern", A.size, _.size, !0),
                        v = b.context,
                        y = c.createCanvasGraphics(v);
                    y.groupLevel = e.groupLevel;
                    this.setFillAndStrokeStyleToContext(y, i, l);
                    y.transform(A.scale, 0, 0, _.scale, 0, 0);
                    y.transform(1, 0, 0, 1, -h, -d);
                    this.clipBbox(y, r, h, d, u, p);
        ...
        var s = function WebGLUtilsClosure() {
            ...
            return {
                ...
                drawFigures: function drawFigures(r, s, a, i, o) {
                    ...
                    var d, u, p, f = 0;
                    for (d = 0, u = i.length; d < u; d++) switch (i[d].type) {
                        case "lattice":
                    ...
                    for (d = 0, u = i.length; d < u; d++) {
                        ...
                        switch (y.type) {
                            case "lattice":
                                var x = y.verticesPerRow;
                                p = C.length / x | 0;
                                for (var k = 1; k < p; k++)
                                    for (var P = k * x + 1, w = 1; w < x; w++, P++) {
                                        g[b] = A[C[P - x - 1]];
                                        g[b + 1] = A[C[P - x - 1] + 1];
                                        g[b + 2] = A[C[P - x]];
                                        g[b + 3] = A[C[P - x] + 1];
            ...
            s = function renderTextLayerClosure() {
                ...
                function appendText(t, r, s) {
                    ...
                    if (t._enhanceTextSelection) {
                        ...
                        var A, _, b = (c.vertical ? r.height : r.width) * t._viewport.scale,
                            v = h;
                        if (0 !== l) {
                            A = [g, m, -m, g, u, p];
                            _ = n.Util.getAxialAlignedBoundingBox([0, 0, b, v], A)
                        } else _ = [u, p, u + b, p + v];
                        t._bounds.push({
                            left: _[0],
                            top: _[1],
                ...
                function expandBoundsLTR(e, t) {
                    ...
                    t.forEach((function(e) {
                        ...
                        e.x1New = l;
                        for (i = t; i <= a; i++) void 0 === (s = (n = r[i]).boundary).x2New ? s.x2 > e.x1 ? s.index > e.index && (s.x2New = s.x2) : s.x2New = l : s.x2New > l && (s.x2New = Math.max(l, s.x2));
                        var h = [],
                            d = null;
                        for (i = t; i <= a; i++) {
        ...
        t.SVGGraphics = SVGGraphics; {
            const e = {
                ...
                l = function() {
                    ...
                    function deflateSync(e) {
                        return function deflateSyncUncompressed(e) {
                            let t = e.length;
                    ...
                    return function convertImgDataToPng(t, r, s) {
                        return function encode(t, r, s, a) {
                            const i = t.width,
                                o = t.height;
                            let l, c, h;
                            const d = t.data;
                            ...
                            if (r === n.ImageKind.GRAYSCALE_1BPP && a) {
                                ...
                                for (let e = 0; e < o; e++) {
                                    p++;
                                    for (let e = 0; e < h; e++) u[p++] ^= 255
                                }
                            }
                            const g = new Uint8Array([i >> 24 & 255, i >> 16 & 255, i >> 8 & 255, 255 & i, o >> 24 & 255, o >> 16 & 255, o >> 8 & 255, 255 & o, l, c, 0, 0, 0]),
                                m = deflateSync(u),
                                A = e.length + 36 + g.length + m.length,
                                _ = new Uint8Array(A);
                            let b = 0;
                            _.set(e, b);
                            b += e.length;
                            writePngChunk("IHDR", g, _, b);
                            b += 12 + g.length;
                            writePngChunk("IDATA", m, _, b);
                            b += 12 + m.length;
                            writePngChunk("IEND", new Uint8Array(0), _, b);
                            return (0, n.createObjectURL)(_, "image/png", s)
                        }(t, void 0 === t.kind ? n.ImageKind.GRAYSCALE_1BPP : t.kind, r, s)
                    }
                }();
            class SVGExtraState {
                constructor() {
            ...
            t.SVGGraphics = SVGGraphics = class SVGGraphics {
                ...
                _makeTilingPattern(e) {
                    const t = e[1],
                        ...
                        [m, A] = n.Util.applyTransform([o, l], s),
                        [_, b] = n.Util.singularValueDecompose2dScale(s),
                        v = c * _,
                        y = h * b,
                        C = this.svgFactory.createElement("svg:pattern");
                    C.setAttributeNS(null, "id", p);
                    C.setAttributeNS(null, "patternUnits", "userSpaceOnUse");
                    C.setAttributeNS(null, "width", v);
                    C.setAttributeNS(null, "height", y);
                    ...
                    const S = this.svg,
                        ...
                        w = this.svgFactory.create(m - f, A - g);
                    this.svg = w;
